    ...
    <div class="container mt-5 text-center">
      <div class="row justify-content-center">
        <div class="col-md-4 text-center">
          ...
          <img class="mb-4 img-fluid rounded float-right" src="/img/logo_ptpn6.jpg" alt="" width="58" height="57">
          <main class="form-signin">
            ...
            <form action="/login" method="post">
              ...
              <div class="form-floating">
                ...
                @enderror" id="username" name="username" placeholder="username" value="{{ old('username') }}" required autofocus>
