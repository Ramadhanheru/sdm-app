...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Edit Daftar Unit Usaha</h1>
</div>
<div class="row justify-content-center my-5">
<div class="col-md-8">

    <form action="/main/category/{{ $category->kode_unit }}" method="post">
      @method('put')
        @csrf
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            ...
            @enderror" id="kode_unit" name="kode_unit" value="{{ $category->kode_unit }}"  required>
            @error('kode_unit')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              @enderror" id="nama_unit" name="nama_unit" value="{{ $category->nama_unit }}" required>
              @error('nama_unit')
              <div class="invalid-feedback text-left">
                {{ $message }}
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              @enderror" id="alias" name="alias" value="{{ $category->alias }}" required>
              @error('alias')
              <div class="invalid-feedback text-left">
                {{ $message }}
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              ...
              @enderror" id="nickname" name="nickname" value="{{ $category->nickname }}" required>
              @error('nickname')
              <div class="invalid-feedback text-left">
                {{ $message }}
              </div>
